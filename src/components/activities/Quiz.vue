<template>
    <div>
        <section class="hero is-info is-small" id="step1-2" v-for="(question, index) in quiz.questions" :key="index" v-if="index <= quiz.currentQuestion">
            <div class="hero-body">
                <div class="container">
                <h1 class="title">
                    {{question.question}}
                ...
                <div class="tile is-ancestor">
                    <div class="tile is-parent" v-for="(option, ind) in question.options" :key="ind">
                        <article @click="checkAnswer(option, quiz)" class="tile is-child notification is-dark" v-bind:class="{ 'is-success animated pulse': option.selected && option.correct,  'is-danger animated shake': option.selected && option.correct == false}">
        ...
        <section class="hero is-success is-small animated fadeInDown" v-if="quiz.completed">
            <div class="hero-body">
                <div class="container">
                    <div class="columns">
                        ...
                        <div class="column">
                            <a class="button is-dark is-medium animated bounceIn">Next Section</a>            
                        </div>
                    </div>
                </div>
            </div>
